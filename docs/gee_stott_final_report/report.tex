...
% ============================================================================
% OVERALL DOCUMENT TODOS - CHECK BEFORE SUBMISSION
% ============================================================================
...
% TODO: Remove unnecessary white spaces throughout
% TODO: Ensure GitHub repository is public and has README with execution instructions
% TODO: Verify all inline TODOs in abstract, baseline, experiments, and conclusion are filled in
% ============================================================================
...
% TODO: Consider if this subsection is redundant with "Dataset Description" in Experiments section (line 158)
% TODO: If keeping both, make sure Related Work focuses on dataset characteristics/prior work,
%       while Experiments section focuses on YOUR specific dataset choices and processing

The Lichess database is a large, publicly available collection of chess games played on the Lichess.org platform. It contains billions of games played by humans of all skill levels, making it an invaluable resource for training human-like chess models. The games are stored in the Portable Game Notation (PGN) format, which includes the moves of the game, the players' ratings (Elo), the game's outcome and other statistics.
...
% TODO: Add baseline model descriptions - this section needs to describe what you're comparing against
% TODO: Include baseline performance metrics (e.g., Maia accuracy, Stockfish with handicaps, random move selection)
% TODO: Describe evaluation metrics used for comparison (accuracy, perplexity, move-matching rate)
% TODO: This section is worth 7% of the grade - needs substantial content beyond just the GitHub link
...
% TODO: This section is worth 10% of the grade - needs comprehensive content with visualizations
% TODO: Add training curves (loss over epochs, accuracy over epochs)
% TODO: Add comparison tables (Rylee vs Maia vs baselines)
% TODO: Include move prediction accuracy by ELO range
% TODO: Add sample games or positions where Rylee made human-like vs superhuman choices
% TODO: Include computational performance metrics (inference time, memory usage)
% TODO: Add statistical significance tests if applicable
% TODO: Include at least 2-3 figures/tables showing experimental results
...
% TODO: Brief recap of the project (what you set out to do)
% TODO: Restate key achievements (what you accomplished - include specific metrics)
% TODO: Final assessment of success (how well did you meet your goals?)
% TODO: Mention limitations encountered
...
% TODO: Final thoughts on the project and what was learned
% TODO: Broader context and significance (impact on human-aligned AI, chess training, accessibility)
% TODO: Why this work matters beyond just chess
